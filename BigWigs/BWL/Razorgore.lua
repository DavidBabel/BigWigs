...
L:RegisterTranslations("enUS", function() return {
	...
	polymorphother_trigger = "(.+) is afflicted by Greater Polymorph\.",--Greater Polymorph\.",
	polymorphyou_trigger = "You are afflicted by Greater Polymorph\.",--Greater Polymorph\.",
	polymorph_message = "%s is polymorphed! Dispel!",
	polymorph_message_you = "You are polymorphed!",
	polymorph_bar = "Polymorph: %s",
	polymorphyouend_trigger = "Greater Polymorph fades from you\.", --"Greater Polymorph fades from you\.",
	polymorphotherend_trigger = "Greater Polymorph fades from (.+)\.",--"Greater Polymorph fades from (.+)\.",
